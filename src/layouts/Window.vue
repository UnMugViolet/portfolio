...
const { id, title, iconSrc, initPositionX, initPositionY, initWidth, initHeight, minWidth, minHeight, headerToolsId, menuHeaderItemsId, resizable, windowsHeaderLogo } =
  defineProps({
    id: String,
    title: Object,
    iconSrc: String,
