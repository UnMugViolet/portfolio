            ...
            <div class="w-full flex justify-end">
              <div class="w-10/12 mr-12">
                <h2 class="text-white text-lg text-right">
                  Pour commencer, cliquez sur mon nom d’utilisateur
                </h2>
              </div>
            </div>
          </div>
          ...
          <div class="app-container">
            <div class="flex justify-between items-center md:gap-8 gap-3">
              ...
              <div class="flex text-white md:text-sm text-xs font-bold md:mr-10 md:w-2/6">
                <h4>
                  Après avoir ouvert ma session, vous pourrez visiter mes projets réalisés dans les
                  dossiers de l’ordinateur. Allez sur le bureau et cliquez sur le dossier projet.
                </h4>
              </div>
            </div>
          </div>
