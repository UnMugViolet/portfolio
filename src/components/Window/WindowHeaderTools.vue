        ...
        <div class="flex items-center h-full min-w-max">
            <div class="flex items-center px-1">
                <div class="flex items-center mr-2">
                    <img src="/src/assets/img/icons/right-arrow-green-icon.png" alt="précédent" class="w-7 h-7 flex-shrink-0"/>
                    <p class="small-p mr-2 cursor-default">Retour</p>
                    <div class="block border-solid down-arrow"></div>
                </div>
                <div class="flex items-center mr-1">
                    <img src="/src/assets/img/icons/left-arrow-green-icon.png" alt="suivant" class="w-7 h-7 flex-shrink-0"/>
            ...
            <div class="rounded-sm border hover:border-gray-300 box-shadow-header-window flex items-center h-8 px-0.5">
                <img src="/src/assets/img/icons/magnifier-icon.png" alt="projects-icon" class="w-auto h-5 flex-shrink-0"/>
