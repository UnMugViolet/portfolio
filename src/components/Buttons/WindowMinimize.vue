<template>
    <button class="minimize-button relative button-window-global-layout border border-white h-full w-6 before:bottom-1 before:left-1 before:absolute before:bg-white before:w-2 hover:brightness-125">
