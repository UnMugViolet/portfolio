<template>
    ...
    <div class="w-full justify-center mt-5 mb-2 flex flex-row items-center gap-0.5 cursor-pointer transition-all hover:underline hover:text-heroic-blue hover:fill-heroic-blue">
      ...
      <a href="https://github.com/UnMugViolet/Logma" target="_blank" class="cursor-pointer">Voir le projet</a>
    </div>
  </div>
</template>